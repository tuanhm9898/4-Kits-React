    ...
    return (
        <div className="col-main" style={{ backgroundColor: "#254171" }}>
            <div className="page-banner">
                <img style={{marginTop:'66px'}} src="https://cdn0.fahasa.com/media/wysiwyg/Thang-12-2021/Phiên chợ cũ1920x500.jpg" alt="" width="100%"/>
            </div>
            <div className="container">
                ...
                <img
                    ...
                    alt="loi"
                />
                <span className="flashsale-header-title ">PHIÊN CHỢ SÁCH CŨ</span>
                </div>
