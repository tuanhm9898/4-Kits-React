    ...
    return (
        <div className="col-main" style={{ backgroundColor: "#254171" }}>
            <div className="page-banner">
                <img style={{marginTop:'66px'}} src="https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/DoChoi/Thang5/Trang_Thi_u_nhi_1.1_1920x700.jpg" alt="" width="100%"/>
            </div>
            <div className="container">
                ...
                <img
                    ...
                    alt="loi"
                />
                <span className="flashsale-header-title ">SÁCH BÁN CHẠY</span>
                </div>
