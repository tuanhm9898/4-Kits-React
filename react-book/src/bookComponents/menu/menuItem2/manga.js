    ...
    return (
        <div className="col-main" style={{ backgroundColor: "#254171" }}>
            <div className="page-banner">
                <img style={{marginTop:'66px'}} src="https://cdn0.fahasa.com/media/wysiwyg/CMS-PAGE/MangaComic/2021-11-15/manga_1920%20x%20600.png" alt="" width="100%"/>
            </div>
            <div className="container">
                ...
                <img
                    ...
                    alt="loi"
                />
                <span className="flashsale-header-title ">MANGA-COMIC</span>
                </div>
